---
title: Best practices for prompt engineering in Elastic Agent Builder
...
url: https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/prompt-engineering
products:
...
# Best practices for prompt engineering in Elastic Agent Builder
...
Prompt engineering in Elastic Agent Builder involves four key areas:
- **Custom instructions**: When you [create a custom agent](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/custom-agents), you define instructions that shape the agent's persona, reasoning patterns, and guardrails.
- **Skill instructions**: When you [create custom skills](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/custom-skills), you write instructions that give agents reusable, task-specific expertise. Refer to [Skill creation guidelines](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/skill-creation-guidelines) for guidance specific to skills.
- **Tool descriptions**: When you [define custom tools](/docs/explore-analyze/ai-features/agent-builder/tools/custom-tools#writing-effective-tool-descriptions), you write descriptions that help the agent understand when and how to use each tool.
- **Chat prompts**: How you phrase your questions when [chatting with agents](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/chat) affects the quality and accuracy of responses.

This guide outlines best practices to help you build reliable, cost-effective agents.
<tip>
  To learn about best practices for creating custom tools, refer to [Create and manage custom tools in Elastic Agent Builder > Best practices](/docs/explore-analyze/ai-features/agent-builder/tools/custom-tools#best-practices).
</tip>


## How agents process prompts

When you chat with an agent, your message is combined with the agent's system-level instructions before being sent to the LLM. [Built-in agents](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/builtin-agents-reference) have preconfigured instructions optimized for their use case. [Custom agents](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/custom-agents) combine your custom instructions with Elastic Agent Builder's base system prompt, which enables core features like visualization and citations.
...
Not every task benefits from prompt engineering. Some tasks are better suited to deterministic [workflows](https://www.elastic.co/docs/explore-analyze/workflows) than to agent-based reasoning. Consider the following when deciding:
...
<tip>
  You can trigger workflows directly from agent conversations using [workflow tools](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/tools/workflow-tools).
</tip>
...
| **Task-specific logic**  | [Skills](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/skills) | Logic that only applies to certain task types. Use a skill to keep custom instructions focused. Refer to [Skill creation guidelines](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/skill-creation-guidelines). |
...
<tip>
  For detailed guidance on writing effective tool descriptions, refer to [Create and manage custom tools in Elastic Agent Builder > Best practices](/docs/explore-analyze/ai-features/agent-builder/tools/custom-tools#best-practices).
</tip>
...
In the context window, custom instructions appear before tool definitions. To maximize prompt caching and reduce latency and [costs](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/monitor-usage):
...
- [Skills in Elastic Agent Builder](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/skills)
...
- [Best practices for tool definitions](/docs/explore-analyze/ai-features/agent-builder/tools/custom-tools#best-practices)
- [Agent Chat](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/chat)